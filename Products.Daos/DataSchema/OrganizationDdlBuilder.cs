...
namespace Products.Daos.DataSchema
{
	public class OrganizationDdlBuilder : DdlBuilder
	{
		...
		{
			return @"CREATE TABLE Organization(Id int IDENTITY(1,1) PRIMARY KEY NOT NULL,Description nvarchar(255),Name nvarchar(255),Description nvarchar(255),Owner_Id int,Entity_Status int)";
		}
